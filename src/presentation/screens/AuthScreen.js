          ...
          <View style={s.form}>
            {isReset ? (
              <>
                ...
                {authError ? <View style={s.alertBox}><Text style={s.alertText}>âš  {authError}</Text></View> : null}
                {authNotice ? <View style={s.noticeBox}><Text style={s.noticeText}>âœ“ {authNotice}</Text></View> : null}
